...
REP_TARGETS = {
    ...
    "Reverse Nordic Curls": "4 Sets × 5–8 Reps", "Heels-Elevated Landmine Squat": "4 Sets × 6–8 Reps", "Bulgarian Split Squats": "3 Sets × 8–10 Reps/leg",
    ...
    "Banded Tricep Pushdowns": "3 Sets × 15–20 Reps", "Romanian Deadlift (RDL)": "3 Sets × 6–8 Reps",
    "Heavy Russian Kettlebell Swings": "3 Sets × 12–15 Reps", "Barbell Hip Thrusts": "2 Sets × 10–12 Reps",
...
MUSCLE_MAP = {
    ...
    "Chest-Supported Rear Delt Flye": {"Shoulders": 1.0, "Back": 0.5}, "Heavy Barbell Front Squat": {"Quads": 1.0, "Glutes": 0.2},
    ...
    "Banded Tricep Pushdowns": {"Triceps": 1.0}, "Romanian Deadlift (RDL)": {"Hamstrings": 1.0, "Glutes": 0.5},
